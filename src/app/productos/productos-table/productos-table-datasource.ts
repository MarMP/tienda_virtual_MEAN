...
/**
 * Data source for the ProductosTable view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ProductosTableDataSource extends DataSource<Producto> {
  data: Producto[] = [];
  paginator: MatPaginator | undefined;
  sort: MatSort | undefined;

  constructor(dataProducts: Producto[]) {
    super();
